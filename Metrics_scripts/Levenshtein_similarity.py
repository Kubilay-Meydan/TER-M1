...
# Using the function
folder = '/Users/kubilaymeydan/Desktop/M1 Bibs/S1/TER/TER-M1/Attributes/input_type'  # Replace with the path to your folder
csv_file = 'input_levenshtein_similarity_matrix.csv'  # Output CSV file name
