...
def extract_input_file_types(file_path):
    ...
    with open(file_path, 'r', encoding='utf-8', errors='ignore') as file:
        ...
        for line in file:
            ...
            elif inside_input_block and (line.startswith('output:') or line.startswith('params:') or line.startswith('log:') or line.startswith('benchmark:') or line.startswith('conda:') or line.startswith('shell:')):
                inside_input_block = False
